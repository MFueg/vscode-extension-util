...
export class Messages {
  private static wrapperTestsuiteIdAmbiguousTitle = new MessageWrapper(
    localize('configuration.testsuite_ambiguous.title', 'Invalid testsuite configuration')
  );

  private static wrapperTestsuiteIdAmbiguousBody = new MessageWrapper(
    localize('configuration.testsuite_ambiguous.text', 'A testsuite with id "{0}" already exists.', '_id_'),
    ['_id_']
  );

  private static wrapperTestsuiteConfigInvalidTitle = new MessageWrapper(
    localize('configuration.testsuite_invalid.title', 'Invalid testsuite configuration')
  );
  ...
  private static wrapperTestsuiteConfigWatchTitle = new MessageWrapper(
    localize('configuration.testsuite_watch.title', 'Watching test suite configuration')
  );
  ...
  private static wrapperTestsuiteConfigWatchTriggerBody = new MessageWrapper(
    localize(
      ...
      'File change on test suite configuration detected: "{0}"',
      '_path_'
    ),
    ['_path_']
  );
